...
TwilioBridgeFlutterApi::TwilioBridgeFlutterApi(flutter::BinaryMessenger* binary_messenger)
 : binary_messenger_(binary_messenger) {}

const flutter::StandardMessageCodec& TwilioBridgeFlutterApi::GetCodec() {
  return flutter::StandardMessageCodec::GetInstance(&flutter::StandardCodecSerializer::GetInstance());
}

void TwilioBridgeFlutterApi::OnTwilioError(
  const EncodableValue& error_arg,
  std::function<void(void)>&& on_success,
  std::function<void(const FlutterError&)>&& on_error) {
  const std::string channel_name = "dev.flutter.pigeon.twilio_sample.TwilioBridgeFlutterApi.onTwilioError";
